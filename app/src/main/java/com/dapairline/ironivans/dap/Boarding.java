...
public class Boarding extends AppCompatActivity {
    ...
    private void listFilesProp(){
        ...
        path = getExternalFilesDir("Boarding")+ File.separator;
        ...
        TextView vacio = (TextView) findViewById(R.id.vacio);
        if(bandera!=0){
    ...
    private void viewPdf(String file) {
        ...
        File pdfFile = new File(getExternalFilesDir("Boarding")+ File.separator+ file);
        //TextView ruta = (TextView) findViewById(R.id.ruta);
        //ruta.setText((CharSequence) pdfFile.toString());
        //Uri path = Uri.fromFile(pdfFile);

        Uri path = FileProvider.getUriForFile(Boarding.this,
